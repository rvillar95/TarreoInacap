                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form  method="post" action="http://127.0.0.1/Tarreo/addJuego" enctype="multipart/form-data" autocomplete="off" target="_top">
                                ...
                                <div class="form-group col-lg-3 col-md-3 col-sm-4 col-xs-12"><label>Hora Realizacion del Juego</label> <div class="input-group clockpicker" data-autoclose="true">
                ...
                $(document).ready(function () {
                    ...
                    $('.dataTables-juegos').DataTable({
                        ...
                        buttons: [
                            ...
                            {extend: 'pdf', title: 'Lista de Participantes'},
                            {extend: 'print',
