        ...
        <div id="page-wrapper" class="gray-bg" style="padding: 0px; margin: 0px;">
            ...
            <div class="wrapper wrapper-content  animated fadeInRight">
                <div class="row" style="padding: 20px;">
                    <h2><strong>Juegos Disponibles Para el Tarreo</strong></h2>
        ...
        $(function() {
            ...
            $(document).ready(function() {
                ...
                $('.dataTables-juegos').DataTable({
                    "ajax": {
                        url: "<?php echo site_url() ?>verJuegosParticipante",
                        type: 'GET'
                    },
                    "columnDefs": [{
                            "targets": 8,
                            "data": null,
                            "defaultContent": '<button type="button" id="btnAddPostulante" class="btn btn-info" data-toggle="modal" data-target="#modal-clase"><i class="glyphicon glyphicon-pencil"></i></button>'
                        }
                ...
                $("body").on("click", "#btnAddPostulante", function(e) {
                    ...
                    agregarPostulante($(idJuego).text(), idUsuario);

                    var table = $('#tabla').DataTable();
                    var table2 = $('#tabla2').DataTable();
                    table.ajax.reload(function(json) {
                        $('#btnAddPostulante').val(json.lastInput);
                    });
